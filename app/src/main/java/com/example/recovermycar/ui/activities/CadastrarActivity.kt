...
class CadastrarActivity : AppCompatActivity() {
    ...
    private fun cadastrarUsuario(){
        ...
        val radioSexo = radioGroup.getCheckedRadioButtonId()
        val sexo :String
        if (radioSexo == 1){
            sexo = "Masculino"
        } else if (radioSexo == 2){
        ...
        if (userName.equals("")) {
            Toast.makeText(applicationContext, "Usuario não preenchido", Toast.LENGTH_SHORT).show()
        } else if (nome.equals("")) {
            ...
            Toast.makeText(applicationContext, "Senhas não preenchidas", Toast.LENGTH_SHORT).show()
        } else if (!password.equals(confirmPassword)) {
            Toast.makeText(applicationContext, "Senhas não conferem", Toast.LENGTH_SHORT).show()
        } else if (email.equals("")) {
            Toast.makeText(applicationContext, "Email não preenchido", Toast.LENGTH_SHORT).show()
        } else if (sexo.equals("")) {
            Toast.makeText(applicationContext, "Sexo não preenchido", Toast.LENGTH_SHORT).show()
        } else if (placa.equals("")) {
            Toast.makeText(applicationContext, "Placa não preenchida", Toast.LENGTH_SHORT).show()
            ...
            Toast.makeText(applicationContext, "Usuario ja Cadastrado", Toast.LENGTH_SHORT).show()
        }
